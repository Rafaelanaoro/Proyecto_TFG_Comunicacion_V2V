...
#define IR_TX_PIN_Pin GPIO_PIN_2
#define IR_TX_PIN_GPIO_Port GPIOA
#define MOTOR_B_IN4_Pin GPIO_PIN_3
#define MOTOR_B_IN4_GPIO_Port GPIOA
#define ARD_D7_Pin GPIO_PIN_4
#define ARD_D7_GPIO_Port GPIOA
#define LED_MODO_Pin GPIO_PIN_5
#define LED_MODO_GPIO_Port GPIOA
...
#define IR_RX_Pin_Pin GPIO_PIN_1
#define IR_RX_Pin_GPIO_Port GPIOB
