...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN14
    */
    GPIO_InitStruct.Pin = JOYSTICK_X_Pin|JOYSTICK_Y_Pin|ARD_A3_Pin|ARD_A2_Pin
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_IN14
    */
    HAL_GPIO_DeInit(GPIOC, JOYSTICK_X_Pin|JOYSTICK_Y_Pin|ARD_A3_Pin|ARD_A2_Pin
                          |ARD_A1_Pin|ARD_A0_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(VL53_SCL_GPIO_Port, VL53_SCL_Pin);

    HAL_GPIO_DeInit(VL53_SDA_GPIO_Port, VL53_SDA_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM15)
  {
    ...
    PA2     ------> TIM15_CH1
    */
    GPIO_InitStruct.Pin = IR_TX_PIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_TIM15;
    HAL_GPIO_Init(IR_TX_PIN_GPIO_Port, &GPIO_InitStruct);
